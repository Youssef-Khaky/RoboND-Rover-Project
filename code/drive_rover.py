...
class RoverState():
    def __init__(self):
        ...
        self.percent_stop = .01
        self.percent_go = .05
        self.stop_forward = 40000/4*self.percent_stop # Threshold to initiate stopping
        self.go_forward = 40000/4*self.percent_go # Threshold to go forward again
